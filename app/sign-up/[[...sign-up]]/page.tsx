...
export default function SignUpPage() {
  return (
    <AuthShell mode="sign-up">
      {clerkConfigured ? <SignUpForm /> : <UnconfiguredNotice mode="sign-up" />}
    </AuthShell>
  );
}
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-warn/30 bg-warn/10 p-3.5">
        ...
        <p className="text-[12.5px] text-ink-mute leading-relaxed">
          ...
          and{" "}
          <code className="font-mono text-ink">CLERK_SECRET_KEY</code> in{" "}
          <code className="font-mono text-ink">.env.local</code> to enable
          GitHub auth.
        </p>
      </div>
